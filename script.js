...
// Observe skill tags and other elements
document.querySelectorAll('.skill-tag, .competency-item, .certification-item, .experience-item, .language-item').forEach(el => {
    el.style.opacity = '0';
...
// Add animation to skill tags with stagger effect
